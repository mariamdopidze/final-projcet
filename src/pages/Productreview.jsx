...
//                 <h3 className="font-bold text-2xl ">{reviewData.title}</h3>
//                 <img
//                   src="/images/Vector.png"
//                    className="w-[16px] h-[18px] mt-3 ml-[390px]"
//                 />
//               </div>
...
//               ))}
//             </div>
//             <button className="w-[175px] h-[44px] mx-auto rounded border border-[#B6B7BC] mt-[64px]">Load more reviews</button>
//           </div>
//         </div>
//       </div>
//       <div>
//         <div className="flex mx-auto max-w-[1116px]">
//           <div>
//           <h3 className="mt-[136px] font-bold text-[#0E1422] text-2xl">You might also like</h3>
//           <span className="mt-[8px] font-medium text-[#878A92] text-xs">SIMILAR PRODUCTS</span>
