...
const Dashboard = () => {
  ...
  return (
    <div>
      <div className="flex ">
        <div className="border w-[260px] h-[925px] border-[#E9E9EB]">
        ...
        <div className="flex-1">
          <header className="mx-auto border-[#E9E9EB] mt-[16px] px-14">
          ...
          <div class="grid grid-cols-3 gap-[38px] mt-[56px] px-14 mx-auto">
            {box.map((item, key) => (
              <div
                key={key}
                className="block my-4 w-full h-[187px] bg-[#F6F6F6] rounded-lg transition-all duration-300 text-start px-3"
              >
                {" "}
                <h3 className="ml-[24px] mt-[24px] font-semibold text-base">
                  {item.title}
                </h3>
          ...
          <div className="flex   mx-auto ml-[48px] gap-[38px] mt-[40px]">
            <div className="w-[328px] h-[475px] border rounded-[8px] border-[#E9E9EB] ">
              <h3 className="font-semibold text-base ml-[32px] mt-[32px]">
                Best Selling
              </h3>
              <span className="font-medium text-xs ml-[32px] mt-[6px]">
                THIS MONTH
              </span>
              ...
              <button className="mt-[24px] w-[270px] h-[28px] ml-[32px] rounded-full border  border-[#E6E7E8] font-medium text-xs">
                Classic Monochrome Tees — $940 Sales
              </button>
              <button className="mt-[24px] w-[267px] h-[28px]  ml-[32px] rounded-full border border-[#E6E7E8] font-medium text-xs">
                Monochromatic Wardrobe — $790 Sales
              </button>
              <button className="mt-[24px] w-[221px] h-[28px]  ml-[32px] rounded-full border border-[#E6E7E8] font-medium text-xs">
              ...
              <img
                ...
                alt=""
                className="ml-[32px] mt-[32px]"
              />
            </div>
            <div className="h-[475px] border rounded-[8px] border-[#E9E9EB] mr-14">
              <div className="flex items-center ml-[40px] mt-[36.5px] gap-2">
                <h3 className="font-semibold text-base">Recent Orders</h3>
                <button className="w-[78px] h-[28px] bg-[#F6F6F6] rounded-full font-medium text-xs">
                  View All
                </button>
              </div>
              <table className="table-fixed w-full mt-[20px] border-collapse">
                ...
                <tbody>
                  {table.map((item) => (
                    <tr
                      key={item.id}
                      className="h-[57px] hover:bg-[#F9F9F9] border-b border-[#E9E9EB] mt-[24px] text-sm text-[#5C5F6A]"
                    >
