  ...
  return (
    <div>
      <div className="flex flex-col items-center justify-center h-full mt-20">
        <button className="font-medium text-xs w-24 h-8 border rounded-full " >shop now</button>
        <button className="font-bold text-base mt-2 w-24 h-8 border rounded-full" >Best Selling</button>
      </div>
